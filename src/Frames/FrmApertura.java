 ...
 * @author Usuario
 */
public class FrmApertura extends javax.swing.JDialog {
     ...
     */
    public FrmApertura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnGuardar.setText("Realizar apertura");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(comboCaja, 0, 125, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmApertura dialog = new FrmApertura(new javax.swing.JFrame(), true);
    ...
    private void inicio() {
        try {
            ...
            con.estaConectado();
            con.cargarCombo("select * from caja", comboCaja);
            modoEdicion(false);
            accionAgregar();
        } catch (SQLException ex) {
            Logger.getLogger(FrmApertura.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void accionGuardar() {
        ...
        Date FechaNac = (Date) txtFecha.getValue();
        SimpleDateFormat sdf=new java.text.SimpleDateFormat("yyyy-MM-dd");        
        String fecha = sdf.format(FechaNac);
        String monto = txtMonto.getText();
        String caja = comJCombox.getComboxString(comboCaja, 1);
  

 
        
        if (operacion == 'A') {
            sentencia = "INSERT INTO aperturacaja (`idAperturaCaja`,`FechaApetura`,`MontoApertura`,`idCaja`)VALUES('" + id + "','" + fecha + "','" + monto + "','" + caja+ "')";
